 ...
 * Created on October 18th, 2017, 1:11 PM
...
// Function Prototypes
void getScore(int &);
void calAvrg(int, int, int, int, int);
...
int main()
{
	...
	calAvrg(Score1, Score2, Score3, Score4, Score5);
...
void calAvrg(int Score1, int Score2, int Score3, int Score4, int Score5)
{
